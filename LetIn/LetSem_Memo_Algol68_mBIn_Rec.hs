...
module LetSem_Memo_Algol68_mBIn_Rec where
...
import AlgolSem_mBIn_Rec_Memo hiding (Constructor, constructor, C_Root, Symboltable)
...
evaluator p = (LetSem_Memo_Algol68_mBIn_Rec.semantics p , nameAnalysis p)
